...
presplash.filename = %(source.dir)s/../build_arm64/splash.png
...
android.permissions = android.permission.INTERNET, (name=android.permission.WRITE_EXTERNAL_STORAGE;maxSdkVersion=18),android.permission.WAKE_LOCK
